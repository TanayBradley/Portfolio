...
<body>
    ...
    <section id="intro">
        <div id="introTitle">
            ...
            <div>I'm an <span id="titleBlock2" class="titleBlockEtc">Experience</span> <span id="titleBlock3" class="titleBlockEtc">Analyst</span> &amp;  <span id="titleBlock4" class="titleBlockEtc">Creative Storyteller</span></div>
        </div>
        <div id="introBody">
